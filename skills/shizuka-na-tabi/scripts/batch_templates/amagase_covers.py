#!/usr/bin/env python3
"""Generate Douyin covers for 天ヶ瀬温泉 clips."""
import base64
from playwright.sync_api import sync_playwright

OUT_DIR = "/Users/likai/Downloads/静かな旅"
...
COVERS = [
    {
        "key": "amagase_01_highlight",
        "frame": "/tmp/frame_01_highlight_120.png",
        "top_label": "OITA · AMAGASE ONSEN",
        "main_title": "天ヶ瀬",
        "sub_title": "Sacred Hot Springs · 1300 Years",
        "mood": ["開湯千三百年の湯煙", "赤い橋と苔の滝", "豊後三大温泉のひとつ"],
        "episode": "Episode 03 · 天ヶ瀬温泉",
        "bg_pos": "center 35%",
    },
    {
        "key": "amagase_02_onsen_town",
        "frame": "/tmp/frame_02_onsen_town_80.png",
        "top_label": "OITA · ONSEN TOWN",
        "main_title": "温泉街",
        "sub_title": "Sulphur Springs & Foot Baths",
        "mood": ["硫黄の香りただよう川沿い", "野湯と足湯と猫の湯", "誰もいない日曜日"],
        "episode": "Episode 03 · 天ヶ瀬温泉",
        "bg_pos": "center 50%",
        "bg_filter": "saturate(0.55) brightness(0.72)",  # 原图太亮，额外压暗
    },
    {
        "key": "amagase_03_ryokan",
        "frame": "/tmp/frame_03_ryokan_40.png",
        "top_label": "AMAGASE · SANSO TENSUI",
        "main_title": "山荘天水",
        "sub_title": "Ryokan Above the Falls",
        "mood": ["桜滝を望む宿", "露天風呂と静寂の夜", "ここだけの時間"],
        "episode": "Episode 03 · 天ヶ瀬温泉",
        "bg_pos": "center 30%",
    },
    {
        "key": "amagase_04_dinner",
        "frame": "/tmp/frame_04_dinner_80.png",
        "top_label": "AMAGASE · EVENING",
        "main_title": "夕食と湯",
        "sub_title": "Dinner & Natural Hot Springs",
        "mood": ["地の食材、静かな夕べ", "湯の花舞うかけ流し", "温泉と料理と、夜の静けさ"],
        "episode": "Episode 03 · 天ヶ瀬温泉",
        "bg_pos": "center 45%",
    },
]
