...
```bash
# 底部 100px 条带「近白像素占比」检测 → 红色底色场景水印的终极防线
DURATION=$(yt-dlp --print "%(duration)s" '<URL>' 2>/dev/null)
...
"
# 任一帧 >30% → 立即 open 帧目视二次确认，阳性即淘汰频道
```
...
_最后更新：2026-04-20（59条完整数据，成熟45条；账号首次爆款出现 → 规律大幅升级）_

| 规律 | 数据支撑 | 置信度 |
|------|---------|--------|
| 🔥 **账号起飞期（2026-04-12~04-20）** | 3-5min 均播 822→**1895**（+131%），涨粉/千 7.0→**9.9**；5min+ 几乎无变化（均播 700、涨粉/千 6.4）→ 方向彻底聚焦 3-5min | ★★★ 高 |
| 🔥 **爆款公式（首次验证，奈良井宿）** | 「まだ街灯の灯る頃、奈良井宿を歩いた。」21129播 **+250粉**，账号历史最高。指标：**5s完播 30.7% · 均时 12.2s · 跳出 44.2% · 点赞 971 · 分享 168 · 收藏 258**。公式 = 3-5min + 中等认知度 + 早朝/情绪化动词标题 + 前5秒 hook 极强 + 互动密度 | ★★★ 高（1样本） |
| 🔥 **封面点击率 ≠ 爆款保证** | 奈良井宿爆款封面点击只有 **8.1%**（精品条均 25-30%），但算法因 5s完播 30.7% 大量推流。结论：**标题+前5秒比封面更决定天花板**；封面只决定小流量池初速度 | ★★★ 高 |
| **3-5min > 5min+**（持续验证） | 3-5min 跳出 49.4% · 涨粉/千播 9.9；5min+ 跳出 52.6% · 涨粉/千播 6.4 | ★★★ 高 |
| ✨ **早朝模板分化：需搭热门地名** | 奈良井宿早朝 21129播（★★★爆）/ 金泽AM7雪 14.1/千（★★）/ 穂高AM5:00 787播 +2粉（冷门地，效率仅 2.5/千，失败）→ 早朝模板只能配**中高认知度地名** | ★★★ 高 |
| ✨ **高认知度地名 × 差异化角度 = 最优解**（持续验证） | 奈良井宿+早朝=爆；奈良+早朝=875播+7粉；鎌倉认知度极高但新条播放起爬慢（需观察）| ★★★ 高 |
| ⚠️ **鎌倉/灌篮高手 IP「暗示标题」初步失效** | 「あの踏切で、海を見た」（灌篮高手暗示）108播 +1粉 · 跳50%；「雨の日だから、鎌倉が好きになった」96播 +2粉；都在爬坡期但起步远低于奈良井宿预期。假设：**中国观众需要直接看到 #鎌倉 #江之电 标签钩子，暗示型标题对非深度二次元观众无效** | ★ 低（待 7 天数据） |
| ✨ **雨天 HOOK = 最低跳出 + 高涨粉** | 江島神社雨 394播 **跳33%** +5粉 / 郡上八幡雨 884播 跳39% +7粉 / 苔の壁雨 370播 跳40% | ★★★ 高 |
| ✨ **夜景 HOOK 分化：动态=可，静态=禁** | 杖立温泉蒸気 1106播 跳47% **+16粉**（本期最强夜景）；长崎俯瞰夜景 55-62%跳 | ★★★ 高 |
| ✨ **12+分钟沉浸长视频 = 抖音生态抑制** | 長野列車 02_long 12分钟版 346播 **70%跳 0粉**；12分钟冥想条 446播 67%跳 +3粉 | ★★★ 高 |
| ✨ **妖怪/秘境 = 最高主页转化** | 妖怪神社 4.4 PV/百播（均值 2.0%）+13粉 | ★★ 中 |
| 🔥 **中文标题搜索命中率远高于日文** | B站竞品：中文标题「千与千寻取景地」127万播 vs 我方日文标题 2.1万播最大。中文标题→抖音搜索池直接命中→算法推荐加速。2026-04-22 修订铁律允许中文标题 | ★★★ 高 |
| ~~中文标题主页访问=0~~ | 已作废 | ✗ 作废 |
| ⚠️ **鎌倉暗示型 IP 标题确认失效** | 暗示「灌篮高手」跳出 51% vs 直接描述 35-40%，差距 16pp → 今后 IP 联想改用直接标签（#鎌倉 #江之电）或中文直述 | ★★★ 高 |
| ⚠️ **千本鳥居 HOOK 帧可能过暗** | 01_highlight 跳出 66.7%（样本小），暗场景 HOOK 需加亮或换帧 | ★★ 中（待确认） |
...
> **选题底层逻辑**：华人对日本的认知不止"地名"，还有**动漫/电影/文化符号**。这些 IP 自带搜索流量池——观众搜"灌篮高手""忠犬八公""情书小樽"时，我们的视频能被命中。
...
> **标题/标签策略**：不直接写 IP 名（版权风险），用**暗示语句**让观众联想：
> - 灌篮高手 →「あの踏切で、海を見た」
> - 情书 →「お元気ですか？ 小樽の丘から」
> - 忠犬八公 →「ここで、ずっと待っていた」
> - 千与千寻 →「この湯屋に、名前を預けてきた」
